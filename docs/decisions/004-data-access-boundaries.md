...
Derived products may connect the visual boilerplate to APIs, databases, or server actions.
Without explicit boundaries, transport details and authorization logic can leak into
Client Components.
...
- Client Components receive minimal serializable data.
