...
async function main(): Promise<void> {
  ...
  try {
    ...
    await assertPath(path.join(fixtureRoot, "src", "app", "(main)", "dashboard", "reports", "page.tsx"));
    await assertPath(
      path.join(fixtureRoot, "src", "app", "(main)", "dashboard", "operations", "_components", "operations-kpis.tsx"),
    );
    await assertPath(
      path.join(fixtureRoot, "src", "app", "(main)", "dashboard", "customers", "[id]", "edit", "page.tsx"),
    );
